...
class ClientController(
    ...
    private val identificarClientePorCPFUseCase: IIdentificarClientePorCPFUseCase
) {
    ...
    fun identificarPorCPF(@PathVariable cpf:String):ResponseEntity<ClientResponse?> {
        try {
            return ResponseEntity.status(HttpStatus.OK).body(identificarClientePorCPFUseCase.identificarClientePorCPF(cpf))
